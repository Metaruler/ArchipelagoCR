...
PARTS_ITEM_TABLE: dict[str, CRItemData] = {
  ...
  "Metal Bear": CRItemData(
    ...
    code=25,
    classification=IC.useful,
    update_ram_addr=[CRRamData(0x803BFB9F, bit_position=8)]
  ),
  "Metal Ox": CRItemData(
    type="Body",
    code=26,
  ...
  "Criminal": CRItemData(
    ...
    code=33,
    classification=IC.useful,
    update_ram_addr=[CRRamData(0x803BFB9E, bit_position=8)]
  ),
  "Buggy": CRItemData(
    type="Body",
    code=34,
  ...
  "Chickenheart": CRItemData(
    ...
    code=48,
    classification=IC.useful,
    update_ram_addr=[CRRamData(0x803BFBA3, bit_position=2)]
  ),
  ...
  "Drill": CRItemData(
    ...
    code=72,
    classification=IC.useful,
    update_ram_addr=[CRRamData(0x803BFBBD, bit_position=8)]
  ),
  ...
  "Trio H": CRItemData(
    ...
    code=161,
    classification=IC.useful,
    update_ram_addr=[CRRamData(0x803BFBFD, bit_position=8)]
  ),
  "Wall Pod": CRItemData(
    type="Pod",
    code=162,
