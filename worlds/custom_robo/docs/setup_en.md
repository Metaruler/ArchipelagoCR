# Custom Robo Multiworld Setup Guide
...
- Your US ISO file, probably named `Custom Robo (USA).iso`
- The GClib (extracted) folder from the lib-windows or lib-linux in the releases page.
- The latest Custom Robo AP world (from releases page). 
...
2. Acquire the most recent APWorld from the ------------------- and place the custom_robo.apworld in the custom_worlds folder of your Archipelago install.
...
2. Open the Archipelago Launcher and click "Generate". This will create a zip file in Archipelago/output
   - You will need to open this .zip to get your .apcr patch file if you are not using the Archipelago website.
...
to continue later.
7. Open Dolphin and from Dolphin, open your newly patched Custom Robo ISO.
...
8. In the server page, there will be a port number. Copy this port number into the top of your CRClient if it did not populate on its own. 
   - The field should read `archipelago.gg:<port number>`
9. Once you have loaded into the game, click the `Connect` button at the top of the CRClient. You are now connected and ready to play!
...
the host will provide you with either a link to download your patch file, or with an APCR patch file that they have extracted from the zip. 
...
to locate your Custom Robo USA ISO.

### Connect to the client

When the ISO patched, the Custom Robo client (CRClient) should have also automatically launched in
...
1. Open Dolphin and from Dolphin, open your newly patched Custom Robo ISO
2. In the server page, there will be a port number. Copy this port number into the top of your CRClient. 
   - The field should read `archipelago.gg:<port number>`
3. Once you have loaded into the game, the client should log that Dolphin has been connected. Click the `Connect` button
at the top of the CRClient. If the port number is correct, you are now connected and ready to play!

### Play the game
### Enjoy your Custom Robo battles!
